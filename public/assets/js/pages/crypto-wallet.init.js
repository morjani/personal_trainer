...
var options, chartOverview, overviewChartColors = getChartColorsArray("overview-chart");
...
}, (chartOverview = new ApexCharts(document.querySelector("#overview-chart"), options)).render(), $(document).ready(function() {
